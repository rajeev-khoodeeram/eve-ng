...
```
cd existing_repo
git remote add origin https://gitlab.com/rajeev-khoodeeram/eve-ng.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/rajeev-khoodeeram/eve-ng/-/settings/integrations)
